...
In pi, type `/memo-wiki` to see all available wiki operations.
...
/memo-wiki scaffold               — customize the vault structure for your domain
```
...
_Generated by agents-memo on first `/memo-wiki init`._
