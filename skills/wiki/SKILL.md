...
2. **INIT**: If the user asks to initialize or scaffold a vault, do NOT run setup yourself — tell them to run `/memo:init` (the extension command). It bootstraps the vault, git-inits it, writes the vault `AGENTS.md`, and offers the weekly lint timer.
