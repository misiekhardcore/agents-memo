---
name: memo-braindump
description: Split long-form text into atomic inbox notes. Accepts inline text or file paths. Triage later via /memo-note process.
when_to_use: '"/memo-braindump <text or file paths>". Splits text into atomic notes in notes/ inbox.'
model: sonnet
effort: medium
user-invocable: true
...
---
Split long-form text into atomic inbox notes. Chunks land in `notes/` for later triage via `/memo-note process`.
